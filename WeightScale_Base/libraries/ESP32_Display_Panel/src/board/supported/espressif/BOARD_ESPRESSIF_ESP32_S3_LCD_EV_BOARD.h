 ...
 */
/**
 * @file   BOARD_ESP32_S3_LCD_EV_BOARD.h
 * @brief  Configuration file for ESP32-S3-LCD-EV-Board(v1.1-v1.4)
 * @author Espressif@lzw655
 * @link   https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-lcd-ev-board/user_guide_v1.4.html
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_S3_LCD_EV_BOARD"
