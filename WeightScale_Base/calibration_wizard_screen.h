...
#else
typedef enum { WIZ_EVT_BACK = 1, WIZ_EVT_PROFILE_100KG, WIZ_EVT_PROFILE_500KG, WIZ_EVT_PROFILE_600KG, WIZ_EVT_NEXT, WIZ_EVT_SAVE } wiz_event_t;
