...
/**
 * @file   BOARD_M5DIAL.h
 * @brief  Configuration file for M5STACK M5DIAL
 * @author Espressif@MacChu0315-Espressif & Espressif@lzw655
 * @link   https://docs.m5stack.com/en/core/M5Dial
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "M5Stack:M5DIAL"
...
#define ESP_PANEL_BOARD_TOUCH_INT_IO            (14)    // Interrupt pin, -1 if not used
