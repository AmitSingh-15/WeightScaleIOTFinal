 ...
 */
/**
 * @file   BOARD_ESP32_S3_TOUCH_LCD_7.h
 * @brief  Configuration file for Waveshare ESP32_S3_TOUCH_LCD_7
 * @author Waveshare@H-sw123
 * @link   https://www.waveshare.com/esp32-s3-touch-lcd-7.htm
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Waveshare:ESP32_S3_TOUCH_LCD_7"
