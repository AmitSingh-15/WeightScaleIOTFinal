 ...
 */
/**
 * @file   BOARD_ESP32_P4_NANO.h
 * @brief  Configuration file for Waveshare ESP32_P4_NANO
 * @author Waveshare@Y1hsiaochunnn
 * @link   https://www.waveshare.com/esp32-p4-nano.htm
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Waveshare:ESP32_P4_NANO"
