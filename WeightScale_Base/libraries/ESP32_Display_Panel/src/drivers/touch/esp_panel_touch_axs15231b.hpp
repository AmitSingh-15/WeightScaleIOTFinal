...
public:
     ...
     */
    TouchAXS15231B(const BusFactory::Config &bus_config, const Config &touch_config):
 ...
 */
using ESP_PanelTouch_AXS15231B [[deprecated("Use `esp_panel::drivers::TouchAXS15231B` instead")]] =
