 ...
 */
/**
 * @file   BOARD_ESP32_S3_TOUCH_LCD_5_B.h
 * @brief  Configuration file for Waveshare ESP32_S3_TOUCH_LCD_5_B
 * @author Waveshare@H-sw123
 * @link   https://www.waveshare.com/esp32-s3-touch-lcd-5.htm?sku=28151
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Waveshare:ESP32_S3_TOUCH_LCD_5_B"
