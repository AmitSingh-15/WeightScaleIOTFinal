 ...
 */
/**
 * @file   BOARD_ESP32_S3_KORVO_2.h
 * @brief  Configuration file for ESP32-S3-Korvo-2
 * @author Espressif@lzw655
 * @link   https://docs.espressif.com/projects/esp-adf/en/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2.html
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_S3_KORVO_2"
 ...
 */
    ...
    /* For panel */
    #define ESP_PANEL_BOARD_LCD_SPI_IO_CS           (-1)     // -1 if not used
...
#define ESP_PANEL_BOARD_LCD_PRE_BEGIN_FUNCTION(p) \
    {  \
        ...
        /* Keep LCD CS low */ \
        expander->digitalWrite(LCD_CS, LOW); \
        return true;    \
    }
