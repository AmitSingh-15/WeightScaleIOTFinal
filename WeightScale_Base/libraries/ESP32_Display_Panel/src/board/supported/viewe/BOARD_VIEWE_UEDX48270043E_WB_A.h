 ...
 */
/**
 * @file   BOARD_UEDX48270043E_WB_A.h
 * @brief  Configuration file for Viewe UEDX48270043E-WB-A
 * @author Viewe@VIEWESMART
 * @link   https://github.com/VIEWESMART/Product-Specification-and-Schematic/blob/main/ESP32/4.3inch/Low-Resolution_480272/UEDX48270043E-WB-A%20SPEC.pdf
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Viewe:UEDX48270043E-WB-A"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_BOUNCE_BUF_SIZE (ESP_PANEL_BOARD_WIDTH * 17)
