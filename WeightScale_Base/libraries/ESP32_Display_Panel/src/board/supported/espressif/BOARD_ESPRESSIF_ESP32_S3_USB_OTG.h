 ...
 */
/**
 * @file   BOARD_ESP32_S3_USB_OTG.h
 * @brief  Configuration file for ESP32-S3-USB-OTG
 * @author Espressif@lzw655
 * @link   https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-usb-otg/index.html
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32-S3-USB-OTG"
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (9)     // Output GPIO pin number
