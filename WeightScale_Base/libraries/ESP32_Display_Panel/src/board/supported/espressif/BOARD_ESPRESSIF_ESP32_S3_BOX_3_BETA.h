 ...
 */
/**
 * @file   BOARD_ESP32_S3_BOX_3_BETA.h
 * @brief  Configuration file for ESP32-S3-Box-3(beta)
 * @author Espressif@lzw655
 * @link   https://github.com/espressif/esp-box/tree/c4c954888e11250423f083df0067d99e22d59fbe
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_S3_BOX_3_BETA"
...
#define ESP_PANEL_BOARD_TOUCH_INT_IO            (3)     // Interrupt pin, -1 if not used
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (47)    // Output GPIO pin number
