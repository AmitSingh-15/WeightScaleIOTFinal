...
public:
     ...
     */
    TouchFT5x06(const BusFactory::Config &bus_config, const Config &touch_config):
 ...
 */
using ESP_PanelTouch_FT5x06 [[deprecated("Use `esp_panel::drivers::TouchFT5x06` instead")]] =
