 ...
 */
/**
 * @file   BOARD_UEDX24320028E_WB_A.h
 * @brief  Configuration file for Viewe UEDX24320028E-WB-A
 * @author Viewe@VIEWESMART
 * @link   https://viewedisplay.com/product/esp32-2-8-inch-240x320-mcu-ips-tft-display-touch-screen-arduino-lvgl-wifi-ble-uart-smart-module/
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Viewe:UEDX24320028E-WB-A"
