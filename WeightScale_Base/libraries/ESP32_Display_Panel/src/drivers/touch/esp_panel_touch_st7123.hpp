...
public:
     ...
     */
    TouchST7123(const BusFactory::Config &bus_config, const Config &touch_config):
 ...
 */
using ESP_PanelTouch_ST7123 [[deprecated("Use `esp_panel::drivers::TouchST7123` instead")]] =
