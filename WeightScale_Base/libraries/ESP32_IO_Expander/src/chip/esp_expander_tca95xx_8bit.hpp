...
public:
     ...
     */
    TCA95XX_8BIT(int scl_io, int sda_io, uint8_t address): Base(scl_io, sda_io, address) {}
     ...
     * @param[in] address I2C device 7-bit address. Should be like `ESP_IO_EXPANDER_I2C_<chip name>_ADDRESS`.
     */
    TCA95XX_8BIT(int host_id, uint8_t address): Base(host_id, address) {}
     ...
     */
    TCA95XX_8BIT(const Config &config): Base(config) {}

    /**
     * @deprecated Deprecated and will be removed in the next major version. Please use other constructors instead.
     */
    [[deprecated("Deprecated and will be removed in the next major version. Please use other constructors instead.")]]
    TCA95XX_8BIT(i2c_port_t id, uint8_t address, int scl_io, int sda_io): Base(id, address, scl_io, sda_io) {}
...
/**
 * @deprecated Deprecated and will be removed in the next major version. Please use `esp_expander::TCA95XX_8BIT` instead.
 */
