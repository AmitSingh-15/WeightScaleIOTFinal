 ...
 */
/**
 * @file   BOARD_ESP32_S3_LCD_EV_BOARD_2.h
 * @brief  Configuration file for ESP32-S3-LCD-EV-Board-2(v1.1-v1.4)
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_S3_LCD_EV_BOARD_2"
