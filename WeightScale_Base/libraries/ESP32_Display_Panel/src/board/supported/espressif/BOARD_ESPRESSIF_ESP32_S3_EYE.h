 ...
 */
/**
 * @file   BOARD_ESP32_S3_EYE.h
 * @brief  Configuration file for ESP32-S3-EYE
 * @author Espressif@lzw655
 * @link   https://github.com/espressif/esp-who/blob/master/docs/en/get-started/ESP32-S3-EYE_Getting_Started_Guide.md
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_S3_EYE"
 ...
 */
    ...
    /* For panel */
    #define ESP_PANEL_BOARD_LCD_SPI_IO_CS           (44)     // -1 if not used
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (48)    // Output GPIO pin number
