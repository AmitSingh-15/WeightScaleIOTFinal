...
public:
     ...
     */
    TouchGT1151(const BusFactory::Config &bus_config, const Config &touch_config):
 ...
 */
using ESP_PanelTouch_GT1151 [[deprecated("Use `esp_panel::drivers::TouchGT1151` instead")]] =
