 ...
 */
/**
 * @file   BOARD_ESP32_C3_LCDKIT.h
 * @brief  Configuration file for ESP32-C3-LCDkit
 * @author Espressif@lzw655
 * @link   https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c3/esp32-c3-lcdkit/index.html
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Espressif:ESP32_C3_LCDKIT"
