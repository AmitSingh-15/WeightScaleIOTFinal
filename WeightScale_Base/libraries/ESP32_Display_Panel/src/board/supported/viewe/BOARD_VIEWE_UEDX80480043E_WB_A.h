 ...
 */
/**
 * @file   BOARD_UEDX80480043E_WB_A.h
 * @brief  Configuration file for Viewe UEDX80480043E-WB-A
 * @author Viewe@VIEWESMART
 * @link   https://viewedisplay.com/product/esp32-4-3-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/
 */
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Viewe:UEDX80480043E-WB-A"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_CLK_HZ          (15 * 1000 * 1000)
